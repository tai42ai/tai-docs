...
<Steps>
  <Step title="Install the runtime">
    The example ships in the `tai-skeleton` repository, so run it from a
    checkout — clone it and install it into a fresh environment, as the
    [installation guide](/getting-started/installation) describes:
