...
are required; tool kwargs, a condition, and the [door-contract
jqs](/concepts/asking-the-caller#the-door-contract) (`start_expr`, `cancel_expr`,
`resume_expr`, `extras_expr`) are optional.
...
keeps any id-bound condition or door-contract jq it carried, so touching the topic or tool
