...
{/* profiles screenshots embedded at mission-end after regen PR — see PLAN_6 F7b */}
...
**Key material is not a profile concern.** Key material — KEKs and signing keys,
the `KeyMaterial` type — is flagged apart from the reload classes and masked like
any secret. It is meant to be rotated out of band, not moved through a profile.
