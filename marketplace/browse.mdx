...
server. The site is a static bundle behind a proxy that forwards `/api` to a
registry; its hostname and that upstream are deployment configuration, set per
deployment and documented in
