...
<Steps>
  ...
  <Step title="Probe routes pinned public">
    The guard denies any route it has no mapping for, so pin your liveness and readiness probes public through the public-routes door before an orchestrator probes them:
