...
| `contract` | The tai-contract compatibility range (a PEP 440 specifier set). |
...
provides:
  - kind: tool
    ...
    module: tai_toolbox.tools.current_time_info
    description: "Return the current time as a structured object."
    tags: [time]
  - kind: tool
    name: generate_embeddings
    module: tai_toolbox.tools.generate_embeddings
...
tai_toolbox = ["py.typed", "tai-plugin.yml"]
```
...
from tai_kit.plugins import load_plugin_spec
