...
<Note>
Requires Python 3.13+. Nothing is on PyPI yet — install from source (`pip install git+https://github.com/tai42ai/tai-skeleton`). This switches to `pip install tai-skeleton` once published.
</Note>
