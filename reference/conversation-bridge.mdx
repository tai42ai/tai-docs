...
| `max_message_chars` | `{twilio: 1600, telegram: 4096, slack: 40000, whatsapp-cloud: 4096}` | Per-channel outbound split caps. A routed channel absent from the map is a loud config error at send. |
