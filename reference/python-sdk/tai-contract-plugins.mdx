...
`tai_contract.plugins.KIND_MANIFEST_BINDINGS`
...
`tai_contract.plugins.ManifestBinding`
...
`tai_contract.plugins.PluginItem`
...
`tai_contract.plugins.PluginItemKind`
...
`tai_contract.plugins.PluginPermissions`
...
`tai_contract.plugins.PluginSpec`
...
`tai_contract.plugins.PluginSpec.ref`
