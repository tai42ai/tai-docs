...
```python
current_extras() -> Mapping[str, Any]
```
...
```python
get_run_delivery() -> tuple[str | None, Mapping[str, Any] | None] | None
```
...
```python
run_delivery(delivery: RunDelivery | None) -> Generator[None]
```
