...
`tai_contract.template` ("what we do with it", the render mixins). The store
...
`tai_contract.storage.ObjectStat`
...
`tai_contract.storage.Storage.load`
...
`tai_contract.storage.Storage.list`
...
`tai_contract.storage.Storage.upload`
...
`tai_contract.storage.Storage.delete`
...
`tai_contract.storage.Storage.delete_dir`
...
`tai_contract.storage.Storage.load_bytes`
...
`tai_contract.storage.Storage.upload_bytes`
...
`tai_contract.storage.Storage.stat`
...
`tai_contract.storage.assert_not_root`
