...
One ``Protocol`` per feature (see `tai_contract.app.facets`), composed into
...
``tai_app`` (see `tai_contract.app.handle`).

## AppAdmin

`tai_contract.app.facets.AppAdmin`
...
`tai_contract.app.facets.AppAdmin.reload_mcp`
...
`tai_contract.app.facets.AppAdmin.deregister_mcp`
...
`tai_contract.app.facets.AppAdmin.reload_config`
...
`tai_contract.app.facets.AppAdmin.tool_reloader`
...
`tai_contract.app.facets.AppAdmin.run_tool_reload`
...
`tai_contract.app.facets.AppAdmin.reload_failed_mcps`
...
`tai_contract.app.facets.AppAdmin.list_failed_mcps`
...
`tai_contract.app.facets.AppAdmin.live_mcp_status`
...
`tai_contract.app.facets.AppAgents`
...
`tai_contract.app.facets.AppAgents.agent`
...
`tai_contract.app.facets.AppAgents.get_agent`
...
`tai_contract.app.facets.AppAgents.all_agents`
...
`tai_contract.app.facets.AppBackends`
...
`tai_contract.app.facets.AppBackends.register_backend`
...
`tai_contract.app.facets.AppBackup`
...
`tai_contract.app.facets.AppBackup.register_section`
...
`tai_contract.app.facets.AppBackup.sections`
...
`tai_contract.app.facets.AppBackup.export_section`
...
`tai_contract.app.facets.AppBackup.import_section`
...
`tai_contract.app.facets.AppChannels`
...
`tai_contract.app.facets.AppChannels.register`
...
`tai_contract.app.facets.AppChannels.get`
...
`tai_contract.app.facets.AppChannels.names`
...
`tai_contract.app.facets.AppClients`
...
`tai_contract.app.facets.AppClients.client_ctx`
...
`tai_contract.app.facets.AppClients.shutdown_clients`
...
`tai_contract.app.facets.AppConfig`
...
`tai_contract.app.facets.AppConnectors`
...
`tai_contract.app.facets.AppConnectors.register_connector`
...
`tai_contract.app.facets.AppConnectors.token_store`
...
`tai_contract.app.facets.AppExtensions`
...
`tai_contract.app.facets.AppExtensions.extension`
...
`tai_contract.app.facets.AppExtensions.available_extensions`
...
`tai_contract.app.facets.AppHttp`
...
`tai_contract.app.facets.AppHttp.middleware`
...
`tai_contract.app.facets.AppHttp.custom_route`
...
`tai_contract.app.facets.AppLifecycle`
...
`tai_contract.app.facets.AppLifecycle.on_startup`
...
`tai_contract.app.facets.AppLifecycle.on_shutdown`
...
`tai_contract.app.facets.AppLifecycle.on_reload`
...
`tai_contract.app.facets.AppLifecycle.on_fleet_op_applied`
...
`tai_contract.app.facets.AppLifecycle.wait_until_ready`
...
`tai_contract.app.facets.AppMonitoring`
...
`tai_contract.app.facets.AppMonitoring.register_monitoring`
...
`tai_contract.app.facets.AppMonitoring.active`
...
`tai_contract.app.facets.AppPresets`
...
`tai_contract.app.facets.AppPresets.bind`
...
`tai_contract.app.facets.AppStorage`
...
`tai_contract.app.facets.AppStorage.register_storage`
...
`tai_contract.app.facets.AppStorage.resource_manager`
...
`tai_contract.app.facets.AppSubApp`
...
`tai_contract.tools.AppTools.tool_title`
...
`tai_contract.tools.AppTools.get_tool`
...
`tai_contract.tools.AppTools.get_tools`
...
`tai_contract.tools.AppTools.get_client_tools`
...
`tai_contract.tools.AppTools.run_tool`
...
`tai_contract.tools.AppTools.remove_tool`
...
`tai_contract.tools.AppTools.register_tool_info`
...
`tai_contract.tools.AppTools.unregister_tool_info`
...
`tai_contract.tools.AppTools.unregister_tool_base`
...
`tai_contract.app.facets.AppVersioning`
...
`tai_contract.app.facets.AppWebhookVerifiers`
...
`tai_contract.app.facets.AppWebhookVerifiers.register`
...
`tai_contract.app.facets.AppWebhookVerifiers.get`
