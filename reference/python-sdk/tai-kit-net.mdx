...
The SSRF guard (`tai_kit.net.url_guard`) resolves and validates each target
...
`tai_kit.net.url_guard.UrlGuardError`
...
`tai_kit.net.url_guard.UrlGuardSettings`
...
`tai_kit.net.url_guard.enforce_size`
...
`tai_kit.net.fetch_url.fetch_url`
...
`tai_kit.net.url_guard.guard_enabled`
...
`tai_kit.net.url_guard.resolve_and_validate`
...
`tai_kit.net.url_guard.url_guard_settings`
