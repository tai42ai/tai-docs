...
| Prop | Type | Description |
|---|---|---|
| `injections` | `readonly ({ into: string; jq: string \| null; template_jq: string \| null })[]` | — |
| `inputJq` | `readonly ResolvedTemplateJq[]` | — |
| `onChange` | `(injections: readonly ({ into: string; jq: string \| null; template_jq: string \| null })[]) => void` | — |
...
**Related:** [ResolvedTemplateJq](/reference/studio-sdk/utilities#resolvedtemplatejq), [TemplateJqSuggestion](/reference/studio-sdk/utilities#templatejqsuggestion)
...
| Prop | Type | Description |
|---|---|---|
| `attach` | `{ input_injections: ({ into: string; jq: string \| null; template_jq: string \| null })[]; scope_expr: string \| null; state: string; subject_expr: string; templates: string[]; updates: ({ adapter: string \| null; jq: string \| null; op_id: string \| null; template_jq: string \| null })[] }` | — |
| `inherited?` | `InheritedSubject` | The target's own binding subject for this state, when it also binds it (precedence). |
| `onChange` | `(attach: { input_injections: ({ into: string; jq: string \| null; template_jq: string \| null })[]; scope_expr: string \| null; state: string; subject_expr: string; templates: string[]; updates: ({ adapter: string \| null; jq: string \| null; op_id: string \| null; template_jq: string \| null })[] }) => void` | — |
| `onRemove` | `() => void` | — |
...
| `inherited?` | `{ states: ({ input_injections: ({ into: string; jq: string \| null; template_jq: string \| null })[]; scope_expr: string \| null; state: string; subject_expr: string; templates: string[]; updates: ({ adapter: string \| null; jq: string \| null; op_id: string \| null; template_jq: string \| null })[] })[] } \| null` | The TARGET's own binding (e.g. the preset a route dispatches), passed by the door screen — never fetched here. A state this binding names that the inherited one also names shows a precedence warning on its card. |
| `loading?` | `boolean` | The catalog fetch is in flight. |
| `onChange` | `(value: { states: ({ input_injections: ({ into: string; jq: string \| null; template_jq: string \| null })[]; scope_expr: string \| null; state: string; subject_expr: string; templates: string[]; updates: ({ adapter: string \| null; jq: string \| null; op_id: string \| null; template_jq: string \| null })[] })[] } \| null) => void` | — |
...
| `value` | `{ states: ({ input_injections: ({ into: string; jq: string \| null; template_jq: string \| null })[]; scope_expr: string \| null; state: string; subject_expr: string; templates: string[]; updates: ({ adapter: string \| null; jq: string \| null; op_id: string \| null; template_jq: string \| null })[] })[] } \| null` | The binding, or `null` when the door binds no state. |
...
**Related:** [BindingSourceSchemas](/reference/studio-sdk/utilities#bindingsourceschemas), [BindingStateOption](/reference/studio-sdk/utilities#bindingstateoption), [BindingTemplateOption](/reference/studio-sdk/utilities#bindingtemplateoption)
...
**Related:** [BindingSourceSchemas](/reference/studio-sdk/utilities#bindingsourceschemas), [BindingStateOption](/reference/studio-sdk/utilities#bindingstateoption), [BindingTemplateOption](/reference/studio-sdk/utilities#bindingtemplateoption), [StateBindingEditorProps](/reference/studio-sdk/utilities#statebindingeditorprops)
...
| Prop | Type | Description |
|---|---|---|
| `onChange` | `(updates: readonly ({ adapter: string \| null; jq: string \| null; op_id: string \| null; template_jq: string \| null })[]) => void` | — |
| `sources?` | `BindingSourceSchemas` | — |
| `suggestions?` | `readonly TemplateJqSuggestion[]` | — |
| `updateJq` | `readonly ResolvedTemplateJq[]` | — |
| `updates` | `readonly ({ adapter: string \| null; jq: string \| null; op_id: string \| null; template_jq: string \| null })[]` | — |
...
**Related:** [BindingSourceSchemas](/reference/studio-sdk/utilities#bindingsourceschemas), [ResolvedTemplateJq](/reference/studio-sdk/utilities#resolvedtemplatejq), [TemplateJqSuggestion](/reference/studio-sdk/utilities#templatejqsuggestion)
