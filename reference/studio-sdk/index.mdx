...
<CardGroup cols={2}>
  ...
  <Card title="Hooks" icon="circle-nodes" href="/reference/studio-sdk/hooks">
    The React hooks and providers every feature builds on — API access, theme, auth, and the interactions stream. (32 exports)
  </Card>
  ...
  <Card title="Host & testing" icon="shield-halved" href="/reference/studio-sdk/host-testing">
    The host-only registry API (loadPlugin / getContributions) and the test-only reset. (15 exports)
  </Card>
</CardGroup>
