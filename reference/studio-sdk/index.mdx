...
<CardGroup cols={2}>
  ...
  <Card title="Components" icon="shapes" href="/reference/studio-sdk/components">
    The design-system components — inputs, layout, tables, pickers, and disclosure primitives. (229 exports)
  </Card>
  ...
  <Card title="Utilities" icon="wrench" href="/reference/studio-sdk/utilities">
    Shared helpers and re-exported types the SDK exposes. (76 exports)
  </Card>
