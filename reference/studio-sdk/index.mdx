...
<CardGroup cols={2}>
  ...
  <Card title="Components" icon="shapes" href="/reference/studio-sdk/components">
    The design-system components — inputs, layout, tables, pickers, and disclosure primitives. (220 exports)
  </Card>
  ...
  <Card title="Host & testing" icon="shield-halved" href="/reference/studio-sdk/host-testing">
    The host-only registry API (loadPlugin / getContributions) and the test-only reset. (17 exports)
  </Card>
</CardGroup>
