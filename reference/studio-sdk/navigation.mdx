...
| `style?` | `CSSProperties` | Inline styles for the anchor. |
| `title?` | `string` | Native tooltip text (also a sensible non-AT hover hint). |
| `to` | `T` | — |
...
| `conversations` | `{ address?: string; q?: string; route?: string; status?: "failed" \| "accepted" \| "pending_delivery" \| "provisional" \| "delivered" \| "shed" \| "silent"; thread?: string }` | — |
| `extensions` | `Record<string, never>` | — |
| `hooks` | `Record<string, never>` | — |
| `interactions` | `Record<string, never>` | — |
| `login` | `Record<string, never>` | — |
| `manifest` | `Record<string, never>` | — |
| `marketplace` | `{ category?: string; kind?: string; plugin?: string; q?: string; sort?: "name" \| "downloads" \| "updated" \| "relevance"; tab?: "browse" \| "installed"; tags?: string[] }` | — |
...
| `states` | `{ state?: string; subject?: string; tab?: "declaration" \| "templates" \| "records" \| "consumers"; target?: string; template?: string }` | — |
| `storage` | `{ q?: string }` | — |
