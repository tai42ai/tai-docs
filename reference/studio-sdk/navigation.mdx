...
|---|---|---|
| `aria-current?` | `boolean \| "time" \| "true" \| "false" \| "page" \| "date" \| "step" \| "location"` | — |
| `aria-label?` | `string` | — |
| `children` | `ReactNode` | — |
| `className?` | `string` | — |
...
**Related:** [NavigateOptions](/reference/studio-sdk/navigation#navigateoptions), [PluginSearch](/reference/studio-sdk/navigation#pluginsearch), [RouteSearch](/reference/studio-sdk/navigation#routesearch), [RouteSearchByToken](/reference/studio-sdk/navigation#routesearchbytoken)
