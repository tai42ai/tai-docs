{/* Generated from examples/access_control/identity_manifest.yaml by scripts/sync_examples.py. Do not edit. */}

```yaml examples/access_control/identity_manifest.yaml
...
# at import. ACCESS_CONTROL_AUTH_PROVIDERS (an ordered JSON list, default ["redis"]) names the chain.
lifecycle_modules:
