{/* Generated from examples/monitoring_backend/inmemory_monitoring.py by scripts/sync_examples.py. Do not edit. */}

```python examples/monitoring_backend/inmemory_monitoring.py
