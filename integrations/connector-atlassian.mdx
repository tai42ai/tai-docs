...
description: "Connect Jira, Confluence, and Compass through the Atlassian 3LO connector."
icon: "jira"
---
...
user, unlocking three services — Jira, Confluence, and Compass. Unlike the
...
<Note>
`tai42-connector-atlassian` is not on PyPI yet, so install it from the repository.
</Note>

## Install and register it

```bash
pip install git+https://github.com/tai42ai/tai-connector-atlassian
```
